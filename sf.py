...
class SchedulingFunctionLPMN(SchedulingFunctionBase):
    ...
    def __init__(self, mote):
        super(SchedulingFunctionLPMN, self).__init__(mote)
    ...
    def start(self):
        # install slotframes for LPMN, which have the same length as
        # Slotframe 0
